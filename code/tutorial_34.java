...
class PetStore {
    ...
    public static void main(String[] args) {
         ...
         // make the labPit have a birthday until it dies.
         while (!labPit.isDead()) {
            labPit.birthday();
            System.out.printf("LabPit Stats = Age: %d, Health: %d\n", labPit.getAge(), labPit.getHealth());
         }

         // stops aging after it is dead.
         labPit.birthday();
         System.out.printf("LabPit Stats after death = Age: %d, Health: %d\n", labPit.getAge(), labPit.getHealth());

         // use our attack method
         System.out.println("Health of pit is " + pit.getHealth());
         dane.attacks(pit);
         System.out.println("After being attacked it is " + pit.getHealth());
